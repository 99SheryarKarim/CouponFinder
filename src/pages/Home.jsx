...
export default function Home(){
  return (
    <div>
      ...
      <Section title="Why Choose CouponFinder?" sub="Advanced features designed to maximize your savings with minimal effort" alt className="animate-fade-in-up animate-delay-3">
        <FeatureGrid/>
      </Section>
    </div>
  )
